...
# 20210806
```{r}
pb3 <- read_xlsx(path = "e:/ZJU/data/RT-PCR/PB3/20210806/summary-20210806.xlsx")
...
pb3 %>% 
    ...
    scale_y_continuous(name = expression(Ct[Pdgf])) +
    scale_x_discrete(name = NULL) +
    geom_abline(intercept = 30, slope = 0, linetype = 2)
ggsave("E:/ZJU/data/RT-PCR/PB3/20210806/PB3-PDGF-expression-Ct.tiff")
...
pb3 %>% 
    ...
    scale_x_discrete(name = NULL) 
ggsave("E:/ZJU/data/RT-PCR/PB3/20210806/PB3-PDGF-expression-dCt.tiff")
```
